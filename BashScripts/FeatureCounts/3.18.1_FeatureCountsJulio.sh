...
#SBATCH -J FeatureCount_Julio(v18.1)
#SBATCH --ntasks=1  
...
######################################################################################################
#Script Name: 3_FeatureCountsJulio.sh 														 	     #
...
BAMDIR="/mnt/scratch/users/gm_001_ucm/lsmc/rodrigo/projects/tRNA/output/Star_Alignment/Juliogtf/1_Juliogtf.18.1/2_Anocounts/*.bam"
OUTDIR="/mnt/home/users/gm_001_ucm/lsmc/rodrigo/projects/tRNA/outputs/Feature_count/1_Juliogtf/1_Featurecounts.18.1/"

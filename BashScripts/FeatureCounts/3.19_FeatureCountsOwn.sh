...
######################################################################################################
#Script Name: 3.19_FeatureCountsOwn.sh 														 	     #
...
BAMDIR="/mnt/scratch/users/gm_001_ucm/lsmc/rodrigo/projects/tRNA/output/Star_Alignment/tRNAgtf/3_tRNA.19/2_Anocounts/*.bam"
OUTDIR="/mnt/home/users/gm_001_ucm/lsmc/rodrigo/projects/tRNA/outputs/Feature_count/2_tRNAgtf/3_Featurecounts.19/"

module load subread

featureCounts -a ${GTFDIR}Mus_musculus.GRCm38.96_tRNA_19.gtf \

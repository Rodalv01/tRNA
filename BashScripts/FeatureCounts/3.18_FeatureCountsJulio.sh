...
#SBATCH -J FeatureCount_Julio(v18)
#SBATCH --ntasks=1  
...
######################################################################################################
#Script Name: 3.18_FeatureCountsJulio.sh 														 	 #
...
BAMDIR="/mnt/scratch/users/gm_001_ucm/lsmc/rodrigo/projects/tRNA/output/Star_Alignment/Juliogtf/2_Juliogtf.18/2_Anocounts/*.bam"
OUTDIR="/mnt/home/users/gm_001_ucm/lsmc/rodrigo/projects/tRNA/outputs/Feature_count/1_Juliogtf/2_Featurecounts.18/"

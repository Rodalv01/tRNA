...
#SBATCH -J StarAlignment_Juliogtf(v19/nocounts)
#SBATCH --ntasks=1  
...
######################################################################################################
#Script Name: 2.19_StarAlignment_nocounts_Juliogtf.sh 											     #
...
OUTDIR="/mnt/scratch/users/gm_001_ucm/lsmc/rodrigo/projects/tRNA/output/Star_Alignment/Juliogtf/3_Juliogtf.19/2_Anocounts/"  #STAR output directory

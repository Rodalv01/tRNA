...
#SBATCH -J StarAlignment_Juliogtf(v18.1/nocounts)
#SBATCH --ntasks=1  
...
######################################################################################################
#Script Name: 2.18_StarAlignment_nocounts_Juliogtf.sh 												 #
#Description: Alignment fastq files with reference genome using STAR with starindex(18.1) that comes #
...
OUTDIR="/mnt/scratch/users/gm_001_ucm/lsmc/rodrigo/projects/tRNA/output/Star_Alignment/Juliogtf/1_Juliogtf.18.1/2_Anocounts/"  #STAR output directory
...
genomeOutput="/mnt/home/users/gm_001_ucm/lsmc/rodrigo/projects/tRNA/data/genomeref/STAR_index/GTFlikeJulio/1_Julioindex.18.1/"

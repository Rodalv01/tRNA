...
#SBATCH -J StarAlignment_Own_19(counts)
#SBATCH --ntasks=1  
...
######################################################################################################
#Script Name: 5_StarAlignment_counts_Own.sh 														 #
...
OUTDIR="/mnt/scratch/users/gm_001_ucm/lsmc/rodrigo/projects/tRNA/output/Star_Alignment/tRNAgtf/3_tRNA.19/1_Acounts/"  #STAR output directory

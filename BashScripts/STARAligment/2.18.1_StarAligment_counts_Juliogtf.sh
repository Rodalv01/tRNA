...
#SBATCH -J StarAlignment_Juliogtf(v18.1/counts)
#SBATCH --ntasks=1  
...
######################################################################################################
#Script Name: 2.18_StarAlignment_counts_Juliogtf.sh 												 #
...
OUTDIR="/mnt/scratch/users/gm_001_ucm/lsmc/rodrigo/projects/tRNA/output/Star_Alignment/Juliogtf/1_Juliogtf.18.1/1_Acounts/"  #STAR output directory

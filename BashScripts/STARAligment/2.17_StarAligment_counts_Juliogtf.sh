...
#SBATCH -J StarAlignment_Juliogtf(v17/counts)
#SBATCH --ntasks=1  
...
OUTDIR="/mnt/scratch/users/gm_001_ucm/lsmc/rodrigo/projects/tRNA/output/Star_Alignment/Juliogtf/2_Juliogtf.17/1_Acounts/"  #STAR output directory
...
genomeOutput="/mnt/home/users/gm_001_ucm/lsmc/rodrigo/projects/tRNA/data/genomeref/STAR_index/GTFlikeJulio/2_Julioindex.7"

...
--genomeDir /mnt/home/users/gm_001_ucm/lsmc/rodrigo/projects/tRNA/data/genomeref/STAR_index/GTFtRNA \
--genomeFastaFiles ${INDIRG}Mus_musculus.GRCm38.dna.primary_assembly.fa \
--sjdbGTFfile ${INDIRGT}Mus_musculus.GRCm38.96_tRNA_19.gtf

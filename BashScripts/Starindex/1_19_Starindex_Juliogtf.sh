...
# (fasta file) which is GRCm38.p6 with the tRNA fasta (v19) file at the end and a GTF (Spiked)    #                                         #
...
--genomeDir /mnt/home/users/gm_001_ucm/lsmc/rodrigo/projects/tRNA/data/genomeref/STAR_index/GTFlikeJulio/3_Julioindex.19 \
--genomeFastaFiles ${INDIRG}Mus_musculus.GRCm38.dna.primary_assembly_tRNA.19.fa \

...
# (fasta file) which is GRCm38.p6 with the tRNA fasta (v18.1) file at the end and a GTF (Spiked)  #                                         #
...
--genomeDir /mnt/home/users/gm_001_ucm/lsmc/rodrigo/projects/tRNA/data/genomeref/STAR_index/GTFlikeJulio/1_Julioindex.18.1 \
--genomeFastaFiles ${INDIRG}Mus_musculus.GRCm38.dna.primary_assembly_tRNA.18.1.fa \

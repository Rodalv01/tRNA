...
# (fasta file) which is GRCm38.p6 with the tRNA (v17) fasta file at the end and a GTF (Spiked)    #                                         #
...
--genomeDir /mnt/home/users/gm_001_ucm/lsmc/rodrigo/projects/tRNA/data/genomeref/STAR_index/GTFlikeJulio/2_Julioindex.17 \
--genomeFastaFiles ${INDIRG}Mus_musculus.GRCm38.dna.primary_assembly_tRNA.17.fa \

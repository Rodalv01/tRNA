...
# (fasta file) which is GRCm38.p6 with the tRNA fasta file at the end and a GTF (Spiked)          #                                         #
...
STAR --runThreadN 6 --runMode genomeGenerate --genomeDir /mnt/home/users/gm_001_ucm/lsmc/rodrigo/projects/tRNA/data/genomeref/STAR_index/GTFlikeJulio --genomeFastaFiles ${INDIRG}Mus_musculus.GRCm38.dna.primary_assembly_tRNA.fa --sjdbGTFfile ${INDIRGT}Spiked_GRCm38_tRNAs.gtf
